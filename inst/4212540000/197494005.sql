...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (196463,194692)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (196463,194692)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (439672,197494)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (439672,197494)
  and c.invalid_reason is null
...
JOIN #Codesets codesets on ((vo.visit_concept_id = codesets.concept_id and codesets.codeset_id = 28))
) C
