...
- * Event cohorts*
- If in your phenotype a person may reasonably be expected to not be in the phenotype after starting in the phenotype: we expect an attempt to model the cohort definition as an event cohort i.e. cohort end date should be modled using exit criteria.
