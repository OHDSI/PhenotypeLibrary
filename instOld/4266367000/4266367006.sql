...
WHERE (C.condition_start_date >= DATEFROMPARTS(2017, 9, 1) and C.condition_start_date <= DATEFROMPARTS(2018, 4, 1))
...
WHERE (C.measurement_date >= DATEFROMPARTS(2017, 9, 1) and C.measurement_date <= DATEFROMPARTS(2018, 4, 1))
...
WHERE (C.observation_date >= DATEFROMPARTS(2017, 9, 1) and C.observation_date <= DATEFROMPARTS(2018, 4, 1))
AND C.value_as_concept_id in (4126681,45877985,9191,45884084,4181412,45879438)
