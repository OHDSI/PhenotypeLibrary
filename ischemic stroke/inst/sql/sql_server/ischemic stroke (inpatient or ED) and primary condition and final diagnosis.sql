...
WHERE C.condition_type_concept_id  in (38000183,38000248,38000199,38000250,44786627) AND c.CONDITION_STATUS_CONCEPT_ID in (4230359) --the constraint for condition_status is added
